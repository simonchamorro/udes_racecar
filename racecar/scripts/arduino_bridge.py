...
class ArduinoBridge:
    ...
    def _raw_odom_cb(self, raw_odom):
        if len(raw_odom.data) == 13: # Firmware APP1
            elapsed_seconds = raw_odom.data[0]
            distance = raw_odom.data[2]
            steering_angle = raw_odom.data[3]
            if elapsed_seconds > 0:
                speed = distance / elapsed_seconds

            #IMU
            linear_acceleration_x = raw_odom.data[4]
            linear_acceleration_y = raw_odom.data[5]
            linear_acceleration_z = raw_odom.data[6]
            angular_velocity_x = raw_odom.data[7]
            angular_velocity_y = raw_odom.data[8]
            angular_velocity_z = raw_odom.data[9]
            magnetic_x = raw_odom.data[10]
            magnetic_y = raw_odom.data[11]
            magnetic_z = raw_odom.data[12]
            
        elif len(raw_odom.data) == 18: # Firmware APP4
